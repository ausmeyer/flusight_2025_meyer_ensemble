...
for (h in 1:4) {
  ...
  lgbm_bounded_wide <- load_model(sprintf('../forecasts/retrospective/lgbm_enhanced_t10_bounded_wide/TwoStage-FrozenMu_h%d_forecasts.csv', h), 'LGBM_bounded_wide', h)
  svm <- load_model(sprintf('../forecasts/retrospective/svm_t100/svm_retrospective_h%d.csv', h), 'SVM', h)
  dfs <- list(baseline, arima, lgbm_blended, lgbm_bounded, lgbm_bounded_wide, svm)
