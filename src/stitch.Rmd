...
fetch_flu <- function() {
  ...
  cdc_meta <- dplyr::select(cdc.locations.file, abbreviation, location, location_name)
  full_data = dplyr::left_join(recent_data, cdc_meta, by = join_by("state" == "abbreviation"))
