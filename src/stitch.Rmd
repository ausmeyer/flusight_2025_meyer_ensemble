...
file_names <- list(
  ...
  ili_output = '../data/ili/ilinet_2025-09-13.csv',                                    # Output ILINet
  ed_output = '../data/ed/ed_2025-09-13.csv',                                          # Output ILINet
  output_final_save = '../data/imputed_sets/imputed_and_stitched_hosp_2025-09-13.csv',
  output_final = '../data/imputed_sets/imputed_and_stitched_hosp.csv'                  # Output file
)
