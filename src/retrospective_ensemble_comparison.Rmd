...
- **TwoStage-Ensemble**: Averaged ensemble of all two-stage model folders
...
cat(sprintf("Number of model folders processed (retrospective): %d\n", length(model_folders)))
...
1. Loading all model forecasts from the retrospective directory
